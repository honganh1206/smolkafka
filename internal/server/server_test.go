...
// Entry point for package test suite,
// think of it like main() for test with argument parsing thingy
func TestMain(m *testing.M) {
	...
	if *debug {
		...
		// Configure our logger with opts
...
func setupTest(t *testing.T, fn func(*Config)) (
	...
	// Export metrics and spans to log files
