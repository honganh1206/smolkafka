...
import (
	...
	"github.com/honganh1206/smolkafka/internal/agent"
...
func main() {
	...
	cmd := &cobra.Command{
		Use: "smolkafka", // Hook function PreRunE: cli.setupConfig, RunE:    cli.run,
...
func setupFlags(cmd *cobra.Command) error {
	...
	dataDir := path.Join(os.TempDir(), "smolkafka")
...
func (c *cli) run(cmd *cobra.Command, args []string) error {
	...
	// Program receive and react to signals
	// by relaying incoming signals to sigc (receive signal from OS and forward to Go channel)
